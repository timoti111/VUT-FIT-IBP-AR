...
//            cc[i] = cs[i] = 0;
//
//        BufferedReader reader = Gdx.files.internal("CORCOEF").reader(8192);
//        try {
//            String line;
//            String[] lineSplit;
//
...
//
//                ig = (n * (n + 1)) / 2 + m + 1;
//                cc[ig] = Double.parseDouble(lineSplit[2]);
//                cs[ig] = Double.parseDouble(lineSplit[3]);
//            }
//            reader.close();
//        } catch (IOException e) {
//            e.printStackTrace();
...
//            hc[(int)n] = hs[(int)n] = 0;
//
//        BufferedReader reader = Gdx.files.internal("EGM96").reader(8192);
//        try {
//            String line;
//            String[] lineSplit;
//
...
//                if (!(n > nmax)) {
//                    n = (n * (n + 1)) / 2 + m + 1;
//                    hc[(int)n] = Double.parseDouble(lineSplit[2]);
//                    hs[(int)n] = Double.parseDouble(lineSplit[3]);
//                }
//            }
//            reader.close();
//        } catch (IOException e) {
